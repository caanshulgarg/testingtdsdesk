...
function viewGstFiling(b, t){
  ...
  // interest and late fee are the portal's: TDS Desk's own estimate shows only if switched on in GST settings (off by default)
  ...
  if (est){
    h += '<p class="note"><b>TDS Desk\u2019s estimate</b> (' + gstSetLink("switched on in GST settings") + "): late fee under section 47, \u20b950 a day (\u20b920 for nil), capped at \u20b9" + money(f3.cap || f1.cap || 0).replace(/\.00$/, "") + " by the turnover of the year before" +
