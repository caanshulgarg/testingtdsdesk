...
function viewGstRegs(b, regs){
  ...
  h += '<div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin-top:8px"><input type="text" data-gregnew data-fk="gregnew" maxlength="15" placeholder="15-character GSTIN" style="width:240px;text-transform:uppercase" autocomplete="off"><button class="btn small primary" data-gregadd>Add GSTIN</button>' +
