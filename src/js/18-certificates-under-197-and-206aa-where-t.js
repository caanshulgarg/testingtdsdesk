...
function viewInputRegister(b){
  ...
  let h = '<section class="dash-card"><h3>Input register, ' + esc(R.months.length > 1 ? "the year " + GSTR.label(R.months[0]) + " to " + GSTR.label(R.months[R.months.length - 1]) : GSTR.label(R.months[0] || "")) + '</h3>' +
