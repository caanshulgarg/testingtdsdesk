...
const Help = {
  ...
  T: {
    ...
    "gst:r3b": {t: "GSTR-3B", what: "The month\u2019s summary return and the tax to pay: 3.1 outward supplies and reverse charge, 3.2 inter-state supplies to unregistered persons, 4 input tax credit, 5 exempt and non-GST inward supplies, and 6 payment with the credit set off.",
      ...
      watch: ["A bill not in 2B gives no credit that month; it is taken in the month its 2B carries it.", "Documents rejected in IMS give no credit; a rejected supplier credit note does not reduce it.", "Credit is used in the order the law sets: IGST first, then CGST and SGST (sections 49 and 49A, rule 88A).", "Our own credit notes rejected by customers are added back to 3.1(a) in the month the portal adds them.", "Rule 37 is off unless switched on for the GSTIN. When on, credit on a bill unpaid 180 days after its date is reversed in 4(B)(2) in the month the 181st day falls in, and taken back in 4(A)(5) and 4(D)(1) when it is paid.", "Late fee and interest are the portal\u2019s own figures. TDS Desk shows its own estimate only if switched on in GST settings."]},
    "gst:qtr": {t: "This quarter (QRMP)", what: "For a GSTIN that files quarterly: what to do this month, one step at a time.",
      steps: ["In the quarter\u2019s first two months: step 1, IFF (optional) \u2014 download the file and upload it by the 13th, so your customers get the credit that month; type the date it was filed.", "Step 2, PMT-06 \u2014 pay the amount shown by the 25th and type what was paid. The fixed-sum method takes 35% of the last quarter\u2019s cash (or all of the last month\u2019s, after monthly filing); self-assessment takes the month\u2019s own tax after credit.", "In the quarter\u2019s last month: step 1, GSTR-1 for the quarter (invoices already sent in IFF are left out); step 2, GSTR-3B for the quarter, where what was paid by PMT-06 is used first."],
      from: "The books for the three months; the filing type and PMT-06 method from GST settings.", watch: ["IFF takes at most \u20b950 lakh a month; the rest waits for the quarter\u2019s GSTR-1.", "3B falls due on the 22nd or the 24th after the quarter, by state."]},
    "gst:cmp08": {t: "CMP-08 (composition)", what: "The quarterly statement of a composition dealer: turnover, tax at the composition rate, and tax on purchases under reverse charge.",
      steps: ["Check the rate in GST settings: 1% for manufacturers and traders (traders on taxable supplies only), 5% for restaurants, 6% for services under notification 2/2019.", "Pay the total in cash and fill the figures on the portal by the 18th after the quarter.", "Type the date filed; interest is worked out if late."],
      from: "Sales and reverse-charge purchases in the books for the quarter.", watch: ["A composition dealer takes no input tax credit and charges no tax on invoices."]},
    "gst:gstr4": {t: "GSTR-4 (composition, the year)", what: "The annual return of a composition dealer.", steps: ["Check table 4 (purchases) against the books.", "Table 5 repeats the year\u2019s CMP-08s.", "File by 30 June after the year."], from: "The year\u2019s books and CMP-08s.", watch: []},
    "gst:vault": {t: "Returns filed", what: "The GST portal\u2019s own PDFs of every return filed, kept per GSTIN and period, with a checklist of what should be on file for the year.",
      steps: ["After filing on the portal, download the return\u2019s PDF there (Returns \u2192 View e-Filed Returns \u2192 Download PDF).", "Drop it here, or click \u201cAdd PDFs from the portal\u201d \u2014 several at once is fine. Each is read for its return, GSTIN, period and ARN and filed in its place.", "Anything that cannot be read for sure waits under \u201cTo sort\u201d: pick the return and period.", "To add a PDF to one line of the checklist, use \u201cadd\u201d on that line.", "Open or download any return when it is needed; \u201cDownload the year\u201d gives every PDF of the year in one zip, named by client, GSTIN, return and period."],
      from: "The PDFs you add. The checklist follows the filing type in GST settings (monthly, QRMP, composition).", watch: ["A PDF for a GSTIN that is not this client\u2019s is refused.", "The ARN date read from a PDF fills the filing date on the GST screens when it is empty.", "When the firm account is on, each PDF is also kept in its cloud documents, so any computer of the firm can open it."]},
