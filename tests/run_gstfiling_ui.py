...
with sync_playwright() as p:
    ...
    ok("Rule 37" in t and "BRANDALIVE" in t and "4(B)(2) reversed" in t, "rule 37: October's unpaid bills listed, reversed in 4(B)(2)")
    pg.fill('input[data-gstf="r3b"]', "2025-12-05"); pg.press('input[data-gstf="r3b"]', "Tab"); pg.wait_for_timeout(3000)
    t = pg.inner_text("#app")
    ok(pg.evaluate("S.books.gstFiled['07']['202510'].r3b") == "2025-12-05" and "Interest under section 50(1)" in t, "a late filing date brings the late fee and section 50 interest")
