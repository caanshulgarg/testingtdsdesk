...
(async () => {
  ...
  ok(Math.abs((T["6J"].igst + T["6J"].cgst + T["6J"].sgst + T["6J"].cess) - (2 * dn + bl)) < 2, "6J is exactly twice the purchase debit notes (counted as credit in 3B) plus bills marked ITC not available: " + M(2 * dn) + " + " + M(bl));
