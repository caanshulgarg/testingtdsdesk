...
with sync_playwright() as p:
    ...
    pg.select_option('select[data-gset="basis"][data-greg="07"]', "books"); pg.wait_for_timeout(2000)
    ...
    pg.evaluate("S.tab = 'gstset'; render()"); pg.wait_for_timeout(2000)
    pg.select_option('select[data-gset="basis"][data-greg="07"]', "2b"); pg.wait_for_timeout(2000)
